...
/*function paginaError($nroError)
    header('Location: /Gestion_/error.php?error='.$nroError.''); 
}*/
...
if ($_REQUEST['causaIncidente'] != '') {
    $causaIncidente = $_REQUEST['causaIncidente'];
} else {
   // paginaError(1);
}
...
id_prioridad,
descripcion)
VALUES(".$si.",\"".$fecha."\", ".$turno.", ".$causaIncidente.",1, ".$idActividad['id'].", ".$reporto.", ".$prioridad.", '".$descripcion."');";
